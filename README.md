...
5. Explain why git is valuable to a team of developers.
     ...
     git is a safe place to store code and work efficiently with multiple users; it also helps store drafts of work via "commit" command.
...
* [ ]  Make your design responsive such that it is accessible on mobile(500px) and tablet(800 px) and matches the mobile wireframe
